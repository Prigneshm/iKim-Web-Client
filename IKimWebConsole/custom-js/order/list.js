$(function () {
    $(document).off('click', '.add-order').on('click', '.add-order', fnCreate);
    ...
    $(document).off('click', '.icon-document').on('click', '.icon-document', function (e) {
        e.preventDefault();
        var orderId = $(this).data('id');
        if (!orderId) return;
        window.location.href = '/OrderLine/Index/' + orderId;
    });
