$(function () {
    $(document).off('click', '.add-stock-batch-item').on('click', '.add-stock-batch-item', fnCreate);
...
function fnCreate() {
    fnHandleAjaxRequest({
        url: '/StockItem/Create',
        onSuccess: function (html) {
            $('#divCreate').html(html);
            $('#modal-stock-batch-item').modal('show');
        },
        onError: function () {
